...
public class SharmhotelRecycle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sharmhotel_recycle);
        ...
        mRecyclerView = findViewById(R.id.recycleHotel_sharm);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mdatabaseReference = mFirebaseDatabase.getReference("data").child("Sharm").child("hotels");
            ...
            public FirebaseViewDataHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                viewDataHolder.setOnClickListener(new FirebaseViewDataHolder.ClickListener() {
                    ...
                    public void onItemClick(View view, int postion) {
                        ...
                        Toast.makeText(SharmhotelRecycle.this, "Click Sharm Item", Toast.LENGTH_SHORT).show();
                    ...
                    public void onItemLongClick(View view, int postion) {
                        ...
                        Toast.makeText(SharmhotelRecycle.this, "Long Click", Toast.LENGTH_SHORT).show();
