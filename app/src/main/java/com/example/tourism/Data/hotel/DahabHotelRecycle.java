...
public class DahabHotelRecycle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dahab_hotel_recycle);

        mLinearLayoutManager = new LinearLayoutManager(this);
        mLinearLayoutManager.setReverseLayout(true);
        mLinearLayoutManager.setStackFromEnd(true);

        mRecyclerView = findViewById(R.id.recycleHotel_dahab);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mdatabaseReference = mFirebaseDatabase.getReference("data").child("dahab").child("hotels");
            ...
            public FirebaseViewDataHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                viewDataHolder.setOnClickListener(new FirebaseViewDataHolder.ClickListener() {
                    ...
                    public void onItemClick(View view, int postion) {
                        ...
                        Toast.makeText(DahabHotelRecycle.this, "Click Sharm Item", Toast.LENGTH_SHORT).show();
                    ...
                    public void onItemLongClick(View view, int postion) {
                        ...
                        Toast.makeText(DahabHotelRecycle.this, "Long Click", Toast.LENGTH_SHORT).show();
