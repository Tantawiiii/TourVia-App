...
public class DahabLandRecycle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dahab_land_recycle);

        mLinearLayoutManager = new LinearLayoutManager(this);
        mLinearLayoutManager.setReverseLayout(true);
        mLinearLayoutManager.setStackFromEnd(true);

        mRecyclerView = findViewById(R.id.recycleLandMarks_Dahab);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mdatabaseReference = mFirebaseDatabase.getReference("data").child("dahab").child("landmarks");
            ...
            public FirebaseViewDataHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                viewDataHolder.setOnClickListener(new FirebaseViewDataHolder.ClickListener() {
                    ...
                    public void onItemClick(View view, int postion) {
                        ...
                        Toast.makeText(DahabLandRecycle.this, "Click Dahab Item", Toast.LENGTH_SHORT).show();
                    ...
                    public void onItemLongClick(View view, int postion) {
                        ...
                        Toast.makeText(DahabLandRecycle.this, "Long Click", Toast.LENGTH_SHORT).show();
