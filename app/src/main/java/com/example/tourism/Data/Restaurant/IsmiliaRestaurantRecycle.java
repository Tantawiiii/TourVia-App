...
public class IsmiliaRestaurantRecycle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ismilia_restaurant_recycle);
        ...
        mRecyclerView = findViewById(R.id.recycleRestaurant_ismalia);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mdatabaseReference = mFirebaseDatabase.getReference("data").child("ismailia").child("restaurant");
