...
public class SharmRestaurantRecycle extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sharm_restaurant_recycle);

        mLinearLayoutManager = new LinearLayoutManager(this);
        mLinearLayoutManager.setReverseLayout(true);
        mLinearLayoutManager.setStackFromEnd(true);

        mRecyclerView = findViewById(R.id.recycleRestaurant_sharm);
        mFirebaseDatabase = FirebaseDatabase.getInstance();
        mdatabaseReference = mFirebaseDatabase.getReference("data").child("Sharm").child("Restaurant");
            ...
            public FirebaseViewDataHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                ...
                viewDataHolder.setOnClickListener(new FirebaseViewDataHolder.ClickListener() {
                    ...
                    public void onItemClick(View view, int postion) {
                        ...
                        Toast.makeText(SharmRestaurantRecycle.this, "Click Sharm Item", Toast.LENGTH_SHORT).show();
                    ...
                    public void onItemLongClick(View view, int postion) {
                        ...
                        Toast.makeText(SharmRestaurantRecycle.this, "Long Click", Toast.LENGTH_SHORT).show();
